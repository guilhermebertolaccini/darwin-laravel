...
@push('after-scripts')
    ...
    <script type="text/javascript">
        ...
        // Wait for Vue component to mount before accessing offcanvas
        let retryCount = 0
        ...
        function initOffcanvas() {
            ...
            if (!formOffcanvas) {
                ...
                if (retryCount < maxRetries) {
                    ...
                    console.warn('form-offcanvas element not found after maximum retries')
                }
                return
            }
        ...
        // Initialize offcanvas when DOM is ready
        initOffcanvas()
