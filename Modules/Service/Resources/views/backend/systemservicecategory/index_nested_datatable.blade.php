...
@section('content')
    ...
    <div data-render="app">
        <system-service-category-form-offcanvas
            ...
            create-title="{{ __('messages.create') }} {{ __('messages.new') }}  Category / Sub Category" edit-title="{{ __('messages.edit') }} Category / Sub Category"
            create-nested-title="{{ __('messages.create') }} {{ __('messages.new') }}  Sub {{ __($module_title) }}" edit-nested-title="{{ __('messages.edit') }} Sub {{ __($module_title) }}"
