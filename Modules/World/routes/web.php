...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth', 'auth_check']], function () {
    ...
    */
    ...
    Route::resource('country', CountryController::class)->middleware(['role.access:admin,demo_admin']);
    ...
    Route::resource('state', StateController::class)->middleware(['role.access:admin,demo_admin']);
    ...
    Route::resource('city', CityController::class)->middleware(['role.access:admin,demo_admin']);
});
